...
function RecipeDetails() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 bg-white rounded-lg shadow-md">
      ...
      <img className="w-full rounded-lg mb-4" src={recipe.image} alt={recipe.title} />
      ...
      <h4 className="text-xl font-medium mt-4">Cooking Time: {recipe.cookingMinutes} minutes</h4>
    </div>
  );
};
